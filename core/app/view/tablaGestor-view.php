      ...
      <div class="modal-body">
	  	<form id="frmDocumentos" enctype="multipart/form-data">
			...
			<?php foreach($archivo2 as $p):?>
				<option value="<?php echo $p->id; ?>" <?php if(isset($_GET["category_id"]) && $_GET["category_id"]==$p->id){ echo "selected"; } ?>><?php echo utf8_encode($p->nombre); ?></option>
			<?php endforeach; ?>
			</select>
			<div class="modal-body">
			...
			<div class="modal-body">
				...
				<!-- <form id="frmcedula" enctype="multipart/form-data">
				</form>	 -->
			</div>	
	...
	<table class="table table-bordered table-hover" id="tablaGestorDataTable">
			...
			foreach($users as $user){
				...
				<td data-titulo="Descargar"> 
					<a href="<?php echo $user->ruta; ?>" 
						download="<?php echo $user->nombre; ?>" class="btn btn-success btn-sm">
				...
				<td data-titulo="Visualizar"> 
					...
					<a class="btn btn-primary btn-sm" 
							...
							onclick="obtenerArchivoPorId('<?php echo $user->id ?>')">
				...
				<td data-titulo="Eliminar"> 
					<span class="btn btn-danger btn-sm" 
						onclick="eliminarArchivo('<?php echo $user->id ?>')">
